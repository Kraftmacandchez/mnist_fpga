...
module layer_two_fsm (
    ...
    wire signed [7:0] w0 = $signed(weight_word[7:0]);
    wire signed [7:0] w1 = $signed(weight_word[15:8]);
    wire signed [7:0] w2 = $signed(weight_word[23:16]);
    wire signed [7:0] w3 = $signed(weight_word[31:24]);
