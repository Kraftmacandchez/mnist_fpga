...
module mnist_fpga_accel #(
    ...
    output wire [31:0] dbg_neuron_index,
    output wire [7:0]  dbg_start_fc2,
    ...
    assign dbg_state        = last_pix_addr;
    assign dbg_result_valid = $unsigned(mac_accum_out);
    assign dbg_neuron_index = fc2_out_latched[9];
    assign dbg_start_fc2    = pix_waddr;
