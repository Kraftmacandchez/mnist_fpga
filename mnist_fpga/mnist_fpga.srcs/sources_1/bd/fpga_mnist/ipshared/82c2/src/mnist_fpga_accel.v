...
module mnist_fpga_accel #(
    ...
    output wire       anode      // Need to activate Anode 0
);
    ...
    assign dbg_result_valid = result_valid;
    ...
    weight_bram #(
        .INIT_FILE("../../mnist_fpga/mnist_fpga.ip_user_files/bd/fpga_mnist/bram_init/weights.mem")
    ) weight_ram1
    (
        .clk(clk),
    ...
    weight_bram #(
        .ADDR_WIDTH(8),
        .INIT_FILE("../../mnist_fpga/mnist_fpga.ip_user_files/bd/fpga_mnist/bram_init/fc2_weights.mem")
    ) weight_ram2
    (
        .clk(clk),
    ...
    bias_bram #(
        .INIT_FILE("../../mnist_fpga/mnist_fpga.ip_user_files/bd/fpga_mnist/bram_init/biases.mem")
    ) bias_ram1
    (
        .clk(clk),
        .addr(bias_bram_addr),
    ...
    bias_bram #(
        .ADDR_WIDTH(4),
        .INIT_FILE("../../mnist_fpga/mnist_fpga.ip_user_files/bd/fpga_mnist/bram_init/fc2_biases.mem")
    ) bias_ram2
    (
        .clk(clk),
    ...
    control_fsm #(
        ...
        .clk(clk),
        .rst_n(rst_n),
        .frame_ready(start_run),     // pulse from UART/pixel capture
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (result_valid && neuron_index_out == 63 && !fc2_started && !busy) begin
