...
HD_PWD='C:/vitis_mnist/mnist_fpga/mnist_fpga.runs/fpga_mnist_lmb_bram_if_cntlr_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_mnist_lmb_bram_if_cntlr_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_mnist_lmb_bram_if_cntlr_1_0.tcl
