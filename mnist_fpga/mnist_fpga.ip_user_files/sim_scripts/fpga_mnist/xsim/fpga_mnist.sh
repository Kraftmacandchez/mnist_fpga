...
#
# Script generated by Vivado on Mon Jan 12 11:48:33 -0500 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fpga_mnist.sh
...
#
# Usage        : fpga_mnist.sh
#                fpga_mnist.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fpga_mnist.sh [-reset_run]
#                fpga_mnist.sh [-reset_log]
#                fpga_mnist.sh [-help]
#
...
# script info
echo -e "fpga_mnist.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fpga_mnist.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fpga_mnist xil_defaultlib.fpga_mnist xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fpga_mnist -key {Behavioral:sim_1:Functional:fpga_mnist} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_1de5.protoinst" -protoinst "protoinst_files/fpga_mnist.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fpga_mnist.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fpga_mnist.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fpga_mnist.sh [-help]\n\
Usage: fpga_mnist.sh [-step]\n\
Usage: fpga_mnist.sh [-lib_map_path]\n\
Usage: fpga_mnist.sh [-reset_run]\n\
Usage: fpga_mnist.sh [-reset_log]\n\
Usage: fpga_mnist.sh [-keep_index]\n\
Usage: fpga_mnist.sh [-noclean_files]\n\n\
