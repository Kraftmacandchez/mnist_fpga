...
HD_PWD='C:/vitis_mnist/clean_build/clean_build.runs/fpga_mnist_mdm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_mnist_mdm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_mnist_mdm_0_0.tcl
