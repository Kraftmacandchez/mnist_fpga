...
HD_PWD='C:/vitis_mnist/clean_build/clean_build.runs/fpga_mnist_mnist_accel_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_mnist_mnist_accel_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_mnist_mnist_accel_0_2.tcl
