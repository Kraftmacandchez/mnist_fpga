...
HD_PWD='C:/vitis_mnist/clean_build/clean_build.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_mnist_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_mnist_wrapper.tcl -notrace
