...
HD_PWD='C:/vitis_mnist/clean_build/clean_build.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_mnist_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_mnist_wrapper.tcl
